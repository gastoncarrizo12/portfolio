      ...
      <div className="items-container">
        ...
        <VerticalTimeline>
          ...
          <VerticalTimelineElement
            ...
            icon={<FontAwesomeIcon icon={faBriefcase} />}
          >
            <h3 className="vertical-timeline-element-title">Desarrollador Java SpringBoot</h3>
            <h4 className="vertical-timeline-element-subtitle">Solven - Aplicación de gestión de aulas</h4>
            <p>
              Aplicación de gestión de aulas. Desarollada desde cero para la entidad "UNSTA"
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
